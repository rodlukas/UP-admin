            ...
            <ul>
                {
                    this.state.users.map(
                        user => <li key={user.id.toString()}>{user.name} {user.surname} - tel: {user.phone}, e-mail: {user.email}, poznamka: {user.note}
                            <br/>terminy:<br/>{user.attendances.map(lecture => <span key={lecture.id.toString()}>{lecture.lecture.course.name} - {lecture.lecture.start}, {lecture.attendancestate.name}<br/></span>)}</li>
                    )
                }
            </ul>
            <div>
